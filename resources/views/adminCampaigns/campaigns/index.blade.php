    ...
    <div class="card">
        <div class="card-header bg-primary d-flex justify-content-between align-items-center">
            ...
            <div>
                ...
                <button type="button" class="btn btn-sm btn-secondary" data-toggle="modal" data-target="#campaignsHelpModal">
                        ...
                        <tr class="campaign-row">
                            ...
                            <td class="text-center">
                                <div class="d-flex justify-content-center">
                                    ...
                                    <form method="POST" 
                                          action="{{ url('/admin/campaigns' . '/' . $item->id) }}" 
                                          class="d-inline">
                                        @method('DELETE')
                                        @csrf
                                        <button type="submit" 
            ...
            <div class="card-footer">
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-center">
                    <div class="mb-2 mb-md-0 text-muted small">
                        Wyświetlono od {{ $campaigns->firstItem() }} do {{ $campaigns->lastItem() }} z {{ $campaigns->total() }} pozycji
                    </div>
