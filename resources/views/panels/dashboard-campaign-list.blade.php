                    ...
                    <td colspan="7">
                        <table class="table table-bordered table-hover sub-campaign-table">
                            ...
                            <tbody>
                                <tr data-widget="expandable-table" aria-expanded="false">
                                    <td><i class="icon-campaigne fa-solid fa-folder-plus"></i>
                                        <img src="https://flagcdn.com/w40/pl.png" alt="Polska" class="flag-icon" />
                                        Podkampania 1
                                    </td>
                                    <td>101</td>
                                    <td>5000</td>
                                ...
                                <tr data-widget="expandable-table" aria-expanded="false">
                                    ...
                                    <td><i class="icon-campaigne fa-solid fa-folder-plus"></i>
                                        <img src="https://flagcdn.com/w40/de.png" alt="Polska" class="flag-icon" />
                                        Podkampania 2
                                    </td>
                                    <td>102</td>
                                    <td>3000</td>
                                    <td><span class="badge badge-success">Zakończona</span>
                                    </td>
                                </tr>
                                <tr class="expandable-body">
                                    <td colspan="5">
                                ...
                                <tr data-widget="expandable-table" aria-expanded="false">
                                    <td><i class="icon-campaigne fa-solid fa-folder-plus"></i>
                                        <img src="https://flagcdn.com/w40/cz.png" alt="Polska" class="flag-icon" />
                                        Podkampania 3
                                    </td>
                                    <td>103</td>
                                    <td>4000</td>
                                    <td><span class="badge badge-danger">Oczekująca</span>
                                    </td>
                                </tr>
                                <tr class="expandable-body">
                                    <td colspan="5">
